...
+
Weitere Einzelheiten finden Sie unter https://docs.netapp.com/us-en/bluexp-backup-recovery/br-start-licensing.html["Einrichten der Lizenzierung für BlueXP backup and recovery"] .
...
+
image:../media/screen-br-dashboard3.png["BlueXP backup and recovery"]
...
Ungelöste Richtlinie in https://raw.githubusercontent.com/NetAppDocs/bluexp-google-cloud-netapp-volumes/main/whats-new.adoc[] - include::../_whatsnew/2025-07-14.adoc[]
