...
+
Verwalten Sie die Speicherintegrität, Governance und Erkennung der Speicherressourcen in der Organisation. Diese Rolle kann auch Software-Updates für Speicherressourcen durchführen.
